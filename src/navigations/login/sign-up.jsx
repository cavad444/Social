...
<div className="login-div">
        ...
        <form align="center" className="login-form">
            ...
            <input onChange={(e)=>changeUsernameValue(e)} placeholder='Enter your username' className='login-input login-username' type="text" />
            <span className='password-text'>Your password</span>
            <input onChange={(e)=>changePasswordValue(e)} pl placeholder='Enter 6 caracter or more' className='login-input login-password' type="password" />
            <span className='password-text'>Repeat password</span>
            <input onChange={(e)=>changeEnterPasswordAgainValue(e)} placeholder='Enter your password again' className='login-input login-password' type="password" />
